    	...
    	.bulletin{
    		...
    		.supports{
    			...
    			.icon{
					...
					&.decrease{
						@include bg-images(seller,decrease_4);
					}
					&.discount{
						@include bg-images(seller,discount_4);
					}
					&.guarantee{
						@include bg-images(seller,guarantee_4);
					}
					&.invoice{
						@include bg-images(seller,invoice_4);
					}
					&.special{
						@include bg-images(seller,special_4);
					}
    			}
    			.text{
    				line-height:16px;
